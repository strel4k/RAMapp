...
final class RMSearchInputView: UIView {
    ...
    private func createButton(with option: RMSearchInputViewViewModel.DynamicOption,
                              tag: Int) -> UIButton {
        let button = UIButton()
    ...
    public func update(option: RMSearchInputViewViewModel.DynamicOption, value: String) {
        ...
        buttons[index].setAttributedTitle(
            NSAttributedString(
                ...
                attributes: [.font: UIFont.systemFont(ofSize: 18, weight: .medium), .foregroundColor: UIColor.link]),
            for: .normal)
    }
}
